...
public class TodoManagementDbContext :
    AbpDbContext<TodoManagementDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(TodoManagementConsts.DbTablePrefix + "YourEntities", TodoManagementConsts.DbSchema);
