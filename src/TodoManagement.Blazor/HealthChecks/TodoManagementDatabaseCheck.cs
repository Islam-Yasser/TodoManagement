...
public class TodoManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public TodoManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
